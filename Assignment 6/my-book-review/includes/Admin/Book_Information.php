...
class Book_Information {
    ...
    public function __construct() {
        add_action( 'init', [ $this, 'wp_br_custom_taxnomi' ] );
    ...
    public function wd_br_book() {
        ...
        register_taxonomy_for_object_type( 'type', 'book' );
    }
    ...
    /**
     * wp_br_custom_taxnomi
     * Create custom taxonomi
     * @return void
     */
    public function wp_br_custom_taxnomi() {
        $labels = [
            'name'               => __( 'Types', 'my-book-review' ),
            'singular_name'      => __( 'Type', 'my-book-review' ),
            'search_items'       => __( 'Search Types', 'my-book-review' ),
            'all_items'          => __( 'All Books', 'my-book-review' ),
            'parent_item'        => __( 'Book', 'my-book-review' ),
            'parent_item_colon'  => __( 'Parent Type', 'my-book-review' ),
            'edit_item'          => __( 'Edit Type', 'my-book-review' ),
            'update_item'        => __( 'Update Type', 'my-book-review' ),
            'add_new_item'       => __( 'Add New Type', 'my-book-review' ),
            'new_item_name'      => __( 'Type Name', 'my-book-review' ),
            'menu_name'          => __( 'Book Type', 'my-book-review' ),
        ];
